...
const Unauthorize = (props) => {
  ...
  return (
    <div className="w3-display-middle">
      <h1 className="w3-jumbo w3-animate-top w3-center" style={{color:"red"}}><>Access Denied</></h1>
      ...
      <h6 className="w3-center w3-animate-zoom" style={{color:"red"}}>error code:403 forbidden</h6>
